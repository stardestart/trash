...
# Установка фона и цвета текста
    tput setab 7  # Установить белый фон
    tput setaf 0  # Установить черный текст
    printf "Введите расширение видеофайла: *."
    tput sgr0     # Сбросить цвета
# Чтение ввода
    read -e ext
...
# Открытие видеофайла
    ...
    PS3="$(echo -e ">")"
    select menudel in "Обработать и сохранить." "Пропустить и удалить."; do
        case "$menudel" in
